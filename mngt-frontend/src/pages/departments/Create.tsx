...
const DepartmentsCreate = () => {
    ...
    //destructuring form
    const {
        refineCore: { onFinish }, handleSubmit,
    ...
    return (
        <CreateView className="class-view">
            ...
            <div className="intro-row">
                <p>Provide the required information below</p>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>
                                                Department Name <span className="text-organge-600">*</span>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>
                                                Description <span className="text-organge-600">*</span>
                                            </FormLabel>
                                            <FormControl>
                                                <Input placeholder="Describe the main focus of this department"
                                                    className="min-h-28"
                                                    {...field} />
                                            </FormControl>
                                            <FormMessage />
